...
brute(binascii.crc32, 8, 0x61089c5c)
brute(binascii.crc32, 34, 0x5888fc1b)
brute(binascii.crc32, 63, 0x66715919)
brute(binascii.crc32, 78, 0x7cab8d64)

md5 = lambda x: hashlib.md5(x).hexdigest()

brute(md5, 0, "89484b14b36a8d5329426a3d944d2983")
brute(md5, 76, "f98ed07a4d5f50f7de1410d905f1477f")
brute(md5, 50, "657dae0913ee12be6fb2a6f687aae1c7")
brute(md5, 32, "738a656e8e8ec272ca17cd51e12f558b")

def place32(offset, value):
    for i in range(4):
        file[offset + i] = value & 0xff
        value >>= 8

place32(52, 0x40793477)
place32(17, 0x676e6972)
place32(59, 0x6f2d6572)
place32(28, 0x52312220)
place32(66, 0x20226d6f)
place32(10, 0x7b206e6f)
place32(37, 0x334b7961)
place32(22, 0x6624203a)
place32(46, 0x7234776c)
place32(70, 0x646e6f63)
place32(80, 0x20662420)
place32(3, 0x6c662065)
place32(41, 0x4d247033)
